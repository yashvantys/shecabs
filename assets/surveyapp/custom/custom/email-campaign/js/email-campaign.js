    ...
    return {
        ...
        adminHome: function() {
            ...
            $('.configurations').dataTable({
                ...
                iDisplayLength: 100,
                ajax: {
                    url: SocialView.base_url + "admin/email-campaign-configurations",
                    type: 'POST'
                },
                aoColumns: [{
                    "mData": "industryName",
                    ...
                    "mRender": function(data, type, full) {
                        ...
                        var deleteLink = $("<a/>").addClass("delete-configuration").attr("config-id", data).attr("href", "#").text("Delete");
                        return deleteLink.prop('outerHTML');

                    }
                }]
            });

            $(".configurations").on("click", ".delete-configuration", function(e) {
                e.preventDefault();
                var me = $(this);
                        ...
                        success: {
                            ...
                            callback: function() {
                                $.ajax({
                                        ...
                                        url: SocialView.base_url + "admin/email-campaign/delete",
                                        data: {
                                            configId: configId
                                        }
                                    })
